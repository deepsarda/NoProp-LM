...
BLOCK_NUM_ENCODER_LAYERS = 3  # Number of transformer encoder layers within each block
...
NOISE_SCHEDULE_TYPE = "cosine"  # Type of noise schedule to use (e.g., "cosine", "linear")

# -----------------------------------------------------------------------------
# Dataset & Tokenization Configuration
# -----------------------------------------------------------------------------
# This section defines the dataset and tokenizer to be used.
DATASET_NAME = "wikitext"  # Name of the dataset (e.g., from Hugging Face datasets library)
...
IGNORE_INDEX = -100  # Index to ignore in loss calculation (typically for padding tokens)
...
GENERATION_MAX_OUTPUT_LENGTH = 16  # Maximum length of generated sequences during logging
